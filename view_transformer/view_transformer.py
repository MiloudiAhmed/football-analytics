...
class ViewTransformer:
    def __init__(self):
        ...
        self.persepective_transformer = cv2.getPerspectiveTransform(self.pixel_verticies, self.target_verticies)
    ...
    def transform_point(self, point):
        ...
        tranform_point = cv2.perspectiveTransform(reshaped_point,self.persepective_transformer)
